...
import { LucideIcon, FolderOpen, Settings, Mail, Calendar, Image, Music, Terminal, Globe, MessageSquare, FileText, Code, ShoppingBag, Film } from 'lucide-react';
...
import { VideoPlayer, videoPlayerMenuConfig } from '../components/apps/VideoPlayer';
...
export const documentViewerMenuConfig: AppMenuConfig = {
    menus: ['File', 'Edit', 'View', 'Window', 'Help'],
    items: {
        'File': [
            { labelKey: 'documentViewer.actions.openFile', action: 'open-file' },
            { type: 'separator' },
            { labelKey: 'menubar.items.getInfo', action: 'get-info' }
        ]
    }
};
...
export const APP_REGISTRY: Record<string, AppMetadata> = {
    ...
    'video-player': {
        ...
        descriptionKey: 'appDescriptions.videoPlayer',
        icon: Film,
    ...
    'document-viewer': {
        ...
        description: 'View PDF and Word documents',
        descriptionKey: 'appDescriptions.documentViewer',
        icon: FileText,
