...
export const ro: TranslationDict = {
  ...
  "appDescriptions": {
    ...
    "documentViewer": "Vizualizare documente PDF și Word"
  },
  "a11y": {
    "common": {
      "close": "Închide",
  ...
  "os": {
    "toasts": {
      ...
      "videoPlayerNotInstalled": "Video Player is not installed. Install it from the App Store.",
      "pdfViewerNotInstalled": "PDF Viewer is not installed. Install it from the App Store."
    }
  },
  "fileManager": {
    "details": {
  ...
  "documentViewer": {
    ...
    "empty": {
      "title": "Document Viewer",
      "description": "Open a PDF or Word file to begin viewing."
    }
  }
};
